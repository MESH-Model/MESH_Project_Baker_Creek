...
#Dry Run
rsync -rultvzi --dry-run hbrauner@graham.computecanada.ca:~/projects/rpp-hwheater/hbrauner/MESH_Project_Baker_Creek/ .

#Regular
#rsync -rultvzi hbrauner@graham.computecanada.ca:~/projects/rpp-hwheater/hbrauner/MESH_Project_Baker_Creek/ .
