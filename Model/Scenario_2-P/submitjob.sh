...
#Copy MESH output
cp MESH_parameters_hydrology.ini MESH_parameters_CLASS.ini Basin_average_*.csv MESH_output_*.txt Metrics_Out.txt $output_fname/
# BASINAVG1/*
done
