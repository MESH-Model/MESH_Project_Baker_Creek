...
for(x in GEMFiles) {
  assign(file_names[i],as.data.frame(read_csv(x,skip=3,col_names=colNames_GEM)))  #Read the file and assign name
  i=i+1
}
```
