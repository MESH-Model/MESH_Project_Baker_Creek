...
folder_S1 <- list.dirs("C:/Users/hlb749/OneDrive - University of Saskatchewan/BakerCreekRun2/Model/Scenario1/Output")
...
####  
folder_S2 <- list.dirs("C:/Users/hlb749/OneDrive - University of Saskatchewan/BakerCreekRun2/Model/Scenario2/Output")
...
####  
folder_S3 <- list.dirs("C:/Users/hlb749/OneDrive - University of Saskatchewan/BakerCreekRun2/Model/Scenario3/Output")
...
####  
folder_S1P <- list.dirs("C:/Users/hlb749/OneDrive - University of Saskatchewan/BakerCreekRun2/Model/Scenario1-P/Output")
...
####  
folder_S2P <- list.dirs("C:/Users/hlb749/OneDrive - University of Saskatchewan/BakerCreekRun2/Model/Scenario2-P/Output")
...
Q_val_load <- read.csv("C:/Users/hlb749/OneDrive - University of Saskatchewan/BakerCreekRun2/Data/Processed/Validation/Streamflow_val.xlsx.csv")
...
## Table summary of Trials except S3, NSE for Cal, and NSE for Val
```{r}
Perf_Summary <- data.frame(Scenario=c("Scenario 1", "Scenario 2", "Scenario 1-P", "Scenario 2-P"), Trial=c(NSRanked_S1$Trial[1], NSRanked_S2$Trial[1],NSRanked_S1P$Trial[1], NSRanked_S2P$Trial[1]),  Cal_NSE=c(NSRanked_S1$NS[1], NSRanked_S2$NS[1],NSRanked_S1P$NS[1], NSRanked_S2P$NS[1]),Val_NSE=c(ValNSES1$NSE[1], ValNSES2$NSE[1], ValNSES1P$NSE[1], ValNSES2P$NSE[1]))
```

## Table summary of Trials except S2P and S3, NSE for Cal, and NSE for Val
```{r eval=FALSE}
Perf_Summary <- data.frame(Scenario=c("Scenario 1", "Scenario 2", "Scenario 1-P"), Trial=c(NSRanked_S1$Trial[1], NSRanked_S2$Trial[1],NSRanked_S1P$Trial[1]),  Cal_NSE=c(NSRanked_S1$NS[1],NSRanked_S2$NS[1],NSRanked_S1P$NS[1]),Val_NSE=c(ValNSES1$NSE[1], ValNSES2$NSE[1], ValNSES1P$NSE[1]))
```
...
FigFolder = "../Presentations/Figures"
ggsave(paste0(FigFolder, "BoxPlot100.jpg"), plot=BoxPlot100, height=9, width=17.75, unit="cm")
...
Q_Full <- read.csv("../Data/Processed/Validation/Streamflow_full.xlsx.csv", col.names=c("DATE","QMeasFull"))
...
ggsave(paste0(FigFolder,"S1Hydrograph.jpg"), plot=S1Hgraph, width=17.75, height=9, units="cm")
...
ggsave(paste0(FigFolder,"S2Hydrograph.jpg"), plot=S2Hgraph, width=17.75, height=9, units="cm")
...
ggsave(paste0(FigFolder, "S3Hydrograph.jpg"), plot=S3Hgraph, width=17.75, height=9, units="cm")
```
...
ggsave(paste0(FigFolder,"S1PHydrograph.jpg"), plot=S1PHgraph, width=17.75, height=9, units="cm")
```
...
ggsave(paste0(FigFolder,"S2PHydrograph.jpg"), plot=S2PHgraph, width=17.75, height=9, units="cm")
```
...
colnames(NSTop10) <- c("S1_Cal", "S1_Val","S2_Cal", "S2_Val", "S1P_Cal", "S1P_Val", "S2P_Cal", "S2P_Val")
...
ggsave(paste0(FigFolder,"Top10Box.jpg"), plot=Top10Box, width=17.75, height=9, units="cm")
...
colnames(AllRanked) <- c("Runs", "S1", "S2", "S1P", "S2P")

# AllRanked <- gather(AllRanked, S1, S2, S3, S1P, S2P, key="Scenario", value="NS")
AllRanked <- gather(AllRanked, S1, S2, S1P, S2P, key="Scenario", value="NS")
...
AllRanked$Scenario <- factor(AllRanked$Scenario, levels=c("S1P", "S2P", "S2", "S1"))
...
ggsave(paste0(FigFolder, "RankedPerf.jpg"), plot=RankedPlot, width=17.75, height=9, unit="cm")
```
...
Perf <- data.frame(Scenario=c(1,2,3,"1P", "2P"), Calibration = c(NSRanked_S1$NS[1],NSRanked_S2$NS[1],NSRanked_S3$NS[1], NSRanked_S1P$NS[1], NSRanked_S2P$NS[1]), Validation=c(ValNSES1$NSE[1], ValNSES2$NSE[1],ValNSES3$NSE[1], ValNSES1P$NSE[1], ValNSES2P$NSE[1]), AvgTime=c(4.714,9.862,35.711, "7.036", "12.402"))
...
```{r eval=FALSE}
ParamIdent(folder_S1, 1, 8) #Resulting OstBest files are called "S1"
