...
folder_S1 <- list.dirs("../Model/Scenario1/Output")
...
####  
folder_S2 <- list.dirs("../Model/Scenario2/Output")
...
####  
folder_S3 <- list.dirs("../Model/Scenario3/Output")
...
####  
folder_S1P <- list.dirs("../Model/Scenario1-P/Output")
...
####  
folder_S2P <- list.dirs("../Model/Scenario2-P/Output")
...
Q_val_load <- read.csv("../Data/Processed/Validation/Streamflow_val.xlsx.csv")
...
```{r eval=FALSE}
Perf_Summary <- data.frame(Scenario=c("Scenario 1", "Scenario 2", "Scenario 3", "Scenario 1-P", "Scenario 2-P"), Trial=c(NSRanked_S1$Trial[1], NSRanked_S2$Trial[1],NSRanked_S3$Trial[1], NSRanked_S1P$Trial[1], NSRanked_S2P$Trial[1]),  Cal_NSE=c(NSRanked_S1$NS[1], NSRanked_S2$NS[1],NSRanked_S3$NS[1], NSRanked_S1P$NS[1], NSRanked_S2P$NS[1]),Val_NSE=c(ValNSES1$NSE[1], ValNSES2$NSE[1],ValNSES3$NSE[1], ValNSES1P$NSE[1], ValNSES2P$NSE[1]))
```
